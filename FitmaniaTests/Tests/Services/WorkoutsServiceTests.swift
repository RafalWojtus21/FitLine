...
final class WorkoutsServiceTests: XCTestCase {
    ...
    func testSaveNewPersonalTrainingPlanError() {
        ...
        let exercises: [WorkoutPart] = [WorkoutPart(workoutPlanName: plan1Name, workoutPlanID: plan1ID, exercise: Exercise(category: .legs, name: "squats"), details: .init(sets: nil, time: 12, breakTime: 24)), WorkoutPart(workoutPlanName: plan1Name, workoutPlanID: plan1ID, exercise: Exercise(category: .chest, name: "push ups"), details: .init(sets: nil, time: 22, breakTime: 25))]
    ...
    func testFetchAllExercises() {
        let exercises = [WorkoutPart(workoutPlanName: "plan Name", workoutPlanID: WorkoutPlanID(workoutPlanID: UUID()), exercise: Exercise(category: .cardio, name: "running"), details: .init(sets: nil, time: 12, breakTime: 25)), WorkoutPart(workoutPlanName: "plan Name 2", workoutPlanID: WorkoutPlanID(workoutPlanID: UUID()), exercise: Exercise(category: .cardio, name: "hiking"), details: .init(sets: nil, time: 222, breakTime: 253))]
