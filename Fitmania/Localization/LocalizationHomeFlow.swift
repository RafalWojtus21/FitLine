...
extension Localization {
    enum HomeFlow {
        static let chooseWorkoutAlert = "HomeScreen.ChooseWorkoutAlert".localized
        static let firstActionTitle = "HomeScreen.FirstActionTitle".localized
        ...
        static let minShortcut = "HomeScreen.MinShortcut".localized
    }
}
